...
public class ListAdapter extends RecyclerView.Adapter<ListAdapter.ListHolder> {
    ...
    public void onBindViewHolder(@NonNull ListHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        String s1 = arrayList.get(position).getIdMenu();
        ...
        holder.editList_items.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                i.putExtra("idMenu",dbHelper.getIdMenu());
                i.putExtra("namaMenu",dbHelper.getNamaMenu());
                i.putExtra("hargaMenu",dbHelper.getHargaMenu());
                context.startActivity(i);
                ManajerActivity.Fa.finish();
            }
        });
        holder.readList_item.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                i.putExtra("namaMenu",dbHelper.getNamaMenu());
                i.putExtra("hargaMenu",dbHelper.getHargaMenu());
//                i.putExtra("date", ServerValue.TIMESTAMP);
                context.startActivity(i);
                ManajerActivity.Fa.finish();
            }
        });
        holder.deleteList_items.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String temp =dbHelper.getIdMenu();
